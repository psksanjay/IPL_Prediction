...
def main():
    ...
    if page == "🏠 Data Overview":
        ...
        with col1:
            ...
            team1 = st.selectbox("Select Team 1", match_data['team1'].unique(), key="team1")
        ...
        with col2:
            ...
            team2 = st.selectbox("Select Team 2", 
                               [t for t in match_data['team1'].unique() if t != team1], 
                               key="team2")
                ...
                for model_name, pred in predictions.items():
                    with st.container():
                        ...
                        with col2:
                            ...
                            st.metric(f"{team2} Win %", f"{team2_prob:.1f}%")
                            st.progress(int(team2_prob))
                        
                        with col3:
                            winner_emoji = "🏆" if pred['predicted_winner'] == team1 else "🎯"
                            st.metric(
                                "Predicted Winner", 
                                f"{winner_emoji} {pred['predicted_winner']}",
